...
| [Linked Lists](#linked-list)                    | [Graphs](#graph)                          |                                   |
| [Stack](#stack)                                 |                                           |                                   |
| [Queue](#queue)                                 |                                           |                                   |
...
| Category                          | Topics                                                                                                                                                           |
| :-------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Algorithm Complexity Analysis** | [Asymptotic Notations](#algorithm-complexity-analysis) • [Recurrence Relations](#algorithm-complexity-analysis)                                                  |
...
On the previous [Data Structures](#data-structures) and [Essential Concepts](#essential-concepts) sections I was including the time and the space complexities of the algorithm functions, now it's the time to dive deep into Algorithm Complexity Analysis topic.
...
**Recurrence Relation** is a mathematical expression that defines a sequence in terms of its previous terms. In the context of algorithmic analysis, it is often used to model the time complexity of recursive algorithms.
...
- _findDuplicates_ - _findMaxMinSingleScan_ - _findMultipleMissingElements_ - _findSingleMissingElement_ - _removeElement_ - _mergeSortedArrays_ - _rotateArray_ - _pairSum_ - _removeDuplicatesFromSortedArray_ - _topKFrequentElements_ - _validSudoku_ - _groupAnagrams_ - _rangeSumQueryImmutable_ - _productOfArrayExceptSelf_ - _distributeCandies_
...
- _hammingWeight_ - _swapVariables_ - _convertBinaryInLinkedListToInt_ - _countingBits_ - _sumOfTwoIntegers_ - _powerOfFour_ - _longestSubsequenceWithNonZeroBitwiseXOR_
...
- _changingCase_ - _countWordsAndVowels_ - _findDuplicates_ - _findDuplicatesBitwise_ - _addBinary_ - _findStringLength_ - _isPalindrome_ - _reverseString_ - _validateString_ - _isAnagram_ - _firstUniqueCharacterInString_ - _stringToIntegerAtoi_ - _romanToInt_ - _integerToRoman_ - _longestCommonPrefix_
...
- _isValidParantheses_ - _prefixToPostfix_ - _minStack_ - _evaluateReversePolishNotation_ - _dailyTemperatures_
